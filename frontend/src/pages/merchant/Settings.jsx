          ...
          {activeTab === 'business' && (
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="font-medium text-gray-800 mb-4">Settlement Preferences</h3>
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <p className="text-gray-600">Daily settlements are processed automatically at 2:00 AM</p>
                  </div>
                </div>
              </div>
            </div>
